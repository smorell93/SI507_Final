...
class NewInfo(db.Model):
    ...
    def __repr__(self):
        return "{} {} is a {} candidate".format(TEST.FirstName, TEST.LastName, self.Gender)
...
#     cand_opponent = ad_data['tgt_id'][rand_int]
...
#     session.add(ad)
#     session.commit()
#     return render_template("userinput.html", first_name = ad.FirstName, last_name = ad.LastName, state = ad.State, district = ad.District, Opponent = ad.Opponent, video = ad.VideoFile)
#
